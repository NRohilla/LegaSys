...
var SharedService = /** @class */ (function () {
    ...
    SharedService.prototype.getalltechnology = function () {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append(this.storage.get('UserToken').access_token, '');
    ...
    SharedService.prototype.getAllTask = function () {
        var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append(this.storage.get('UserToken').access_token, '');
        return this.http.get('http://localhost:58164/task/getalltask', this.headers);
    };
...
/* harmony import */ var _projenctModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../projenctModel */ "./src/app/layout/project/projenctModel.ts");
...
var AddComponent = /** @class */ (function () {
    function AddComponent(dialogRef, data, dataService, fb, router) {
        ...
        this.regiForm = fb.group({
            ...
            'DomainName': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            'DOB': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            'Gender': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            'Blog': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
            ...
            'ProjectDomain_ID': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
        });
        this.getClient();
    ...
    AddComponent.prototype.GetAllTechnology = function () {
        var _this = this;
        this.dataService.getalltechnology().subscribe(function (res) {
    ...
    AddComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_0__["MatDialogRef"],
            _projenctModel__WEBPACK_IMPORTED_MODULE_4__["Project"],
            _Shared_shared_service__WEBPACK_IMPORTED_MODULE_2__["SharedService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"]])
    ], AddComponent);
    return AddComponent;
}());
...
module.exports = "<app-page-header [heading]=\"'Edit'\" [icon]=\"'fa-bar-chart-o'\"></app-page-header>\n<div [@routerTransition]>\n    <div *ngIf=\"projectdetails\">\n        <form class=\"mat-dialog-content\" (ngSubmit)=\"submit\" #formControl=\"ngForm\">\n            <div class=\"form contactlist-container mat-elevation-z8\">\n                <mat-tab-group mat-align-tabs=\"center\">\n                    <mat-tab label=\"Project Information\" style=\"background: steelblue;\">\n                        <div>\n\n\n                            <div class=\"form-group\">\n                                <div class=\"col-lg-12\" style=\"margin-bottom: 1%;\">\n                                    <div class=\"row\">\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.ProjectID\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                        <div class=\"col-md-2\">\n\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.ProjectName\"\n                                                    name=\"ProjectName\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.ProjectDescription\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.Duration\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n\n                            <div class=\"form-group\">\n                                <div class=\"col-lg-12\" style=\"margin-bottom: 1%;\">\n                                    <div class=\"row\">\n                                        <div class=\"col-md-2\">\n\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.StartDate\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n\n                                        </div>\n                                        <div class=\"col-md-2\">\n\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.EndDate\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n\n                                        </div>\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.ProjectDescription\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Project ID</mat-label>\n                                                <input matInput #input class=\"form-control\" [(ngModel)]=\"projectdetails.Duration\"\n                                                    name=\"ProjectID\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n\n\n                            <div class=\"form-group\">\n                                <div class=\"col-lg-12\" style=\"margin-bottom: 1%;\">\n                                    <div class=\"row\">\n                                        <div class=\"col-md-2\">\n\n\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Description</mat-label>\n                                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\"\n                                                    placeholder=\"State\" [(ngModel)]=\"projectdetails.DomainName\" name=\"DomainName\"\n                                                    maxlength=\"10\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n\n                                        </div>\n                                        <div class=\"col-md-2\">\n\n\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Client Name</mat-label>\n                                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\"\n                                                    placeholder=\"State\" [(ngModel)]=\"projectdetails.ClientName\" name=\"ClientName\"\n                                                    maxlength=\"10\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n\n\n                                        </div>\n                                        <div class=\"col-md-2\">\n                                            <mat-form-field appearance=\"outline\">\n                                                <mat-label>Description</mat-label>\n                                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\"\n                                                    placeholder=\"State\" [(ngModel)]=\"projectdetails.Description\" name=\"Description\"\n                                                    maxlength=\"10\" required>\n                                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                                            </mat-form-field>\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n\n                        </div>\n                    </mat-tab>\n\n                    <mat-tab label=\"Client  Information\">\n                        <div>\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Project ID</mat-label>\n                                <input matInput #input class=\"form-control\" placeholder=\"Id\" [(ngModel)]=\"projectdetails.ProjectID\"\n                                    name=\"ProjectID\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Description</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.DomainName\" name=\"DomainName\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Client Name</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.ClientName\" name=\"ClientName\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Client Name</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.Description\" name=\"Description\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                        </div>\n                    </mat-tab>\n\n                    <mat-tab label=\"Resource   Information\">\n                        <div>\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Project ID</mat-label>\n                                <input matInput #input class=\"form-control\" placeholder=\"Id\" [(ngModel)]=\"projectdetails.ProjectID\"\n                                    name=\"ProjectID\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Description</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.DomainName\" name=\"DomainName\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Client Name</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.ClientName\" name=\"ClientName\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                            <mat-form-field appearance=\"outline\">\n                                <mat-label>Client Name</mat-label>\n                                <input matInput #inputstate class=\"form-control\" [disabled]=\"disable\" placeholder=\"State\"\n                                    [(ngModel)]=\"projectdetails.Description\" name=\"Description\" maxlength=\"10\" required>\n                                <mat-error *ngIf=\"formControl.invalid\">{{getErrorMessage()}}</mat-error>\n                            </mat-form-field>\n\n                        </div>\n                    </mat-tab>\n\n\n                </mat-tab-group>\n                <div mat-dialog-actions class=\"margin-left\">\n                    <button mat-button [type]=\"submit\" mat-raised-button color=\"primary\" *ngIf=\"savevisible\" (click)=\"edit()\">Edit</button>\n                    <button mat-button [type]=\"submit\" [color]=\"'success'\" mat-raised-button color=\"primary\" *ngIf=\"editvisible\"\n                        (click)=\"edit()\">Save</button>\n                    <button mat-raised-button (click)=\"onNoClick()\" tabindex=\"-1\" color=\"warn\">Cancel</button>\n                </div>\n            </div>\n\n            <!-- <button mat-button [type]=\"submit\" [disabled]=\"!formControl.valid\" [mat-dialog-close]=\"1\" (click)=\"edit()\">Edit</button> -->\n\n\n        </form>\n    </div>\n\n</div>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _Shared_shared_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Shared/shared.service */ "./src/app/layout/Shared/shared.service.ts");
...
var EditComponent = /** @class */ (function () {
    function EditComponent(route, dataService, router, project) {
        var _this = this;
        this.route = route;
        this.dataService = dataService;
        this.router = router;
    ...
    EditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _Shared_shared_service__WEBPACK_IMPORTED_MODULE_1__["SharedService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _projenctModel__WEBPACK_IMPORTED_MODULE_4__["Project"]])
    ], EditComponent);
...
module.exports = "<div><button title=\"Create\" [color]=\"'success'\" mat-raised-button color=\"accent\" (click)=\"addProject()\">Create</button></div>\n<app-page-header [heading]=\"'Project'\" [icon]=\"'fa-bar-chart-o'\"></app-page-header>\n      <div class=\"container mat-elevation-z8\">\n        <div class=\"form\">\n                <mat-form-field>\n                        <input matInput (keyup)=\"applyFilter($event.target.value)\" placeholder=\"Filter\">\n                      </mat-form-field>\n        </div>\n            <mat-table #table [dataSource]=\"dataSource\" class=\"mat-cell\"  matSort>\n              <ng-container matColumnDef=\"ProjectID\">\n                <mat-header-cell mat-sort-header *matHeaderCellDef> Project Id </mat-header-cell>\n                <mat-cell *matCellDef=\"let element\"> {{element.ProjectID}} </mat-cell>\n              </ng-container>\n              <ng-container matColumnDef=\"ClientName\">\n                <mat-header-cell *matHeaderCellDef mat-sort-header> Client Name</mat-header-cell>\n                <mat-cell *matCellDef=\"let element\"> {{element.ClientName}}</mat-cell>\n              </ng-container>\n              <ng-container matColumnDef=\"Description\">\n                <mat-header-cell *matHeaderCellDef mat-sort-header> Description </mat-header-cell>\n                <mat-cell *matCellDef=\"let element\"> {{(element.Description)}} </mat-cell>\n              </ng-container>\n\n              <!-- Birth Column -->\n              <!-- <ng-container matColumnDef=\"DomainName\">\n                <th mat-header-cell *matHeaderCellDef> Birthday </th>\n                <td mat-cell *matCellDef=\"let element\"> {{element.birth | date: 'MM-dd-yyyy' }} </td>\n              </ng-container> -->\n\n              <ng-container matColumnDef=\"DomainName\">\n                <mat-header-cell *matHeaderCellDef mat-sort-header> DomainName </mat-header-cell>\n                <mat-cell *matCellDef=\"let element\"> {{element.DomainName}} </mat-cell>\n              </ng-container>\n              <ng-container matColumnDef=\"actions\">\n                <mat-header-cell *matHeaderCellDef> Action </mat-header-cell>\n                <mat-cell *matCellDef=\"let element\">\n                  <button title=\"Edit\" mat-raised-button color=\"primary\" (click)=\"editproject(element)\">View</button>\n                  <button title=\"Delete\" mat-raised-button color=\"accent\" *ngIf=\"element.Status=='1'\" (click)=\"deleteproject(element.ProjectID)\">Activate</button>\n                  <button title=\"Delete\" mat-raised-button color=\"warn\" *ngIf=\"element.Status=='0'\" (click)=\"deleteproject(element.ProjectID)\">Delete</button>\n                </mat-cell>\n              </ng-container>\n\n              <mat-header-row *matHeaderRowDef=\"displayedColumns\"></mat-header-row>\n              <mat-row *matRowDef=\"let row; columns: displayedColumns;\"></mat-row>\n            </mat-table>\n            <!-- <div class=\"no-results\" [style.display]=\"dataSource.renderedData == 0 ? '' : 'none'\">\n                    No results\n                  </div> -->\n\n                  <mat-paginator\n\n                                 [pageIndex]=\"0\"\n                                 [pageSize]=\"10\"\n                                 [pageSizeOptions]=\"[1,5, 10, 25, 100]\">\n                  </mat-paginator>\n                </div>\n\n        <!-- <template #messagecontainer>\n            </template> -->\n\n"
...
var ProjectModule = /** @class */ (function () {
    ...
    ProjectModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_project_component__WEBPACK_IMPORTED_MODULE_3__["ProjectComponent"], _edit_edit_component__WEBPACK_IMPORTED_MODULE_5__["EditComponent"], _add_add_component__WEBPACK_IMPORTED_MODULE_9__["AddComponent"]],
...
/*!*************************************************!*\
  !*** ./src/app/layout/project/projenctModel.ts ***!
  \*************************************************/
/*! exports provided: Issue, Project */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
