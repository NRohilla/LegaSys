...
export class ClientProfesionalDetailsComponent implements OnInit {
  ...
  UpdateClient() {
    ...
    this.currentClientDetails.ClientExtension=this.professionalDetailsForm.controls['extension'].value;
   ...
   // this.professionalDetailsForm.controls['companyZipcode'].errors.required
    ...
    if (!this.readOnly) {
      switch (formControlName) {
        ...
        case 'companyZipcode': return "Postal Code";
  ...
  LoadProfessionalDetailsForm(){
    ...
    this.professionalDetailsForm.controls['extension'].setValue(this.currentClientDetails.ClientExtension);
  }
  ...
  CreateProfessionalDetailsForm(){
    this.professionalDetailsForm = this.formBuilder.group({
      ...
      companyPhone: ['',[Validators.required,Validators.pattern('^[1-9][0-9]{9}')]],
  ...
  SelectCountryCode(){
    ...
    for(var i=0;i<this.countries.length;i++){
      if(this.countries[i].name==this.professionalDetailsForm.controls['companyCountry'].value){
        this.professionalDetailsForm.controls['countryCode'].setValue(this.countries[i].code);
